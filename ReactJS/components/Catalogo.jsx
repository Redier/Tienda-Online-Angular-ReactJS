...
class Catalogo extends React.Component {
    ...
    busquedaProductos(event) {
        ...
        patronEscrito= patronEscrito.toLowerCase();
        ...
        for (var index = 0; index < productos.length; index++) {
            ...
            var auxElement=element.nombre.toLowerCase();
            if (auxElement.includes(patronEscrito)) {
    ...
    getProductos() {
        request
            ...
            .end((err, res) => {
                ...
                request
                    .get('https://tiendaonline-33689.firebaseio.com/Pedidos.json')
                    .set('Content-Type', 'application/json')
